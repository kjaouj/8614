...
def safe_mode_reply(state: AgentState, reason: str) -> str:
    ...
    base = (
        "Bonjour,\n\n"
        "Merci pour votre message. Afin de pouvoir vous répondre de manière fiable, "
        "il nous manque certains éléments.\n\n"
        "Pourriez-vous préciser :\n"
        "- le contexte exact de votre demande,\n"
        "- toute référence utile (cours/projet/date/document),\n"
        "- et l’échéance attendue ?\n\n"
        "Bien cordialement."
    )
    return base
